...
# Google очень чувствителен к частым запросам, поэтому используем большую задержку
# со случайной составляющей для естественности
REQUEST_DELAY = 60  # Базовая задержка 60 секунд (1 минута)
REQUEST_DELAY_MIN = 50  # Минимальная случайная задержка
REQUEST_DELAY_MAX = 70  # Максимальная случайная задержка
