...
# Скрипт для развертывания SEO-парсера на удаленном сервере

set -e

echo "========================================="
echo "  Развертывание SEO-парсера"
echo "========================================="
...
echo -e "\n[2/5] Установка Python 3 и pip..."
sudo apt-get install -y -qq python3 python3-pip python3-venv git

# Создаем директорию проекта
echo -e "\n[3/5] Создание директории проекта..."
PROJECT_DIR="$HOME/seo-parser"
mkdir -p "$PROJECT_DIR"
cd "$PROJECT_DIR"
...
cat > google_trends_parser.py << 'EOF'
"""
